...
#     seconds = range(0, 60)
    ...
    def __init__(self, group=None, target=None, name='thread_control', args=(), kwargs=None): # , interval=0.1):
#         self.interval = interval
        threading.Thread.__init__(self, group=group, target=target, name=name, args=args, kwargs=kwargs)
...
#     seconds = range(0, 60)
    ...
    def __init__(self, group=None, target=None, name='thread_eval', args=(), kwargs=None): # , interval=0.1):
#         self.interval = interval
        threading.Thread.__init__(self, group=group, target=target, name=name, args=args, kwargs=kwargs)
